...
def generate_map():
    ...
    # using room data, scenery data and prop date.
    ...
    # Add middle lines of room map (wall, floor to fill width, wall)  (5)
    for y in range(room_height - 2):
        room_map.append([side_edge]
                        + [floor_type]*(room_width - 2) + [side_edge])

    # Add bottom line of room map (6)
    ...
    if current_room % MAP_WIDTH != 1: # If room is not on left of map  (9)
        ...
        if room_to_left[4]: # If exit at right of this room
